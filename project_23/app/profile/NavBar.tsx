...
export default function NavBar() {
    return (
        <nav className='absolute flex justify-between max-sm:w-full bottom-0 left-0 md:h-2/3'>
            <div className='flex relative w-full flex-row md:flex-col md:flex-nowrap justify-around max-sm:mt-5 border-t-2 border-gray-200
                ...
                <div className='flex absolute items-center justify-center -bottom-3 left-1/2 -translate-x-1/2  w-1/6 md:relative md:grow'>
                    <button className='flex w-full justify-center items-center transition-all hover:-translate-y-4 rounded-full aspect-square bg-blue-700 text-lg text-white'>+</button>
                </div>
