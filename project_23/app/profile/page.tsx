      ...
      <div className="flex flex-col mt-20 h-3/4">
        <div className="flex max-sm:flex-col mt-14 bg-white items-center h-full">
          <div className="flex flex-col items-center md:w-1/2 md:h-2/3">
            <div className="rounded-full z-20 text-transparent m-2 bg-white w-1/3 aspect-square">
              Profile avatar
            </div>
            <div className="text-blue-900 font-semibold text-sm my-1">
              Profile Name
            </div>
            ...
            <div className="flex my-2">
              <button className="py-1 px-2 mr-1 rounded-lg bg-blue-700 text-white text-sm">
                Edit profile
              </button>
              <button className="py-1 px-2 ml-1 rounded-lg bg-blue-700 text-white text-sm">
                Add friends
              </button>
            </div>
          </div>

          <div className="max-sm:w-full md:w-1/2 items-center justify-between">
            <ContentTabs />
          </div>
          <NavBar />
        </div>
