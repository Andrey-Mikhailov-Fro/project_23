...
export default function ContentTabs() {
    ...
    const activeClass = 'text-blue-700 border-b-2 grow border-blue-700 mt-2 px-8 transition-all duration-500';
    const nonActiveClass = 'text-gray-500 border-b-2 border-gray-500 mt-2 px-8 transition-all duration-500';
    ...
    return (
        <>
            <div className='flex w-full justify-between'>
                <button onClick={handleClick(activeTypes.Photos)} className={tabsActiveButtonClasses.photos}>Photos</button>
                <button onClick={handleClick(activeTypes.Likes)} className={tabsActiveButtonClasses.likes}>Likes</button>
            </div>
